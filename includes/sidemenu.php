    ...
    <div class="flex flex-col h-full">
        ...
        <div class="px-4 pt-4 pb-2">
            <div class="flex items-center gap-2 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 rounded-md">
                ...
                <input type="text" placeholder="Pesquisar" class="w-full bg-transparent text-base text-gray-700 dark:text-gray-300 placeholder-gray-500 border-0 focus:ring-0 p-0">
        ...
        <nav class="mt-4 px-2">
            <div class="space-y-1">
                <a href="<?php echo getenv('BASE_URL'); ?>/home" 
                   class="flex items-center gap-2 px-3 py-2 text-base text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md">
